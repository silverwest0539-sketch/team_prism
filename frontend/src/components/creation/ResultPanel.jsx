...
const ResultPanel = ({ content }) => {
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex flex-col h-full min-h-0 overflow-hidden">
      ...
      {/* 1. 상단 툴바 */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 border-b border-gray-100 bg-white">
      ...
      {/* 2. 탭 메뉴 */}
      <div className="flex px-4 border-b border-gray-200 gap-4 sm:gap-6 overflow-x-auto scrollbar-hide">
        <button className="py-3 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600">결과물</button>
        <button className="py-3 text-sm font-medium text-gray-500 hover:text-gray-800 transition">해시태그</button>
      ...
      {/* 4. 플로팅 액션 바 */}
      <div className="p-4 border-t border-gray-100 bg-gray-50 flex flex-wrap items-center gap-2">
        ...
        <button className="flex items-center gap-1 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-full text-sm font-bold hover:bg-gray-100 transition whitespace-nowrap sm:ml-auto">
